...
var LAST_ROUTE_REGEX = /(@import '[A-Za-z0-9_-]+-route';)(?!.*@import '[A-Za-z0-9_-]+-route';)/;
var LAST_COMPONENT_REGEX = /(@import '[A-Za-z0-9_-]+-component';)(?!.*@import '[A-Za-z0-9_-]+-component';)/;
...
WildlandStylesGenerator.prototype.addRouteSheetImport = function(routeName) {
  var routeImportCode = "@import '" + routeName + "-route';";
